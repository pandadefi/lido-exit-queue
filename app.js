const BACKEND_REFRESH_INTERVAL_MS = 60 * 60_000;
const REFRESH_FETCH_START_AGE_MS = BACKEND_REFRESH_INTERVAL_MS;
const REFRESH_RETRY_INTERVAL_MS = 60_000;
const NODE_OFFLINE_AFTER_MS = 2 * BACKEND_REFRESH_INTERVAL_MS;
